          ...
          <div class="participants-section">
            ...
            ${
              details.participants.length > 0
                ? `<ul>${details.participants.map((email) => `<li><span>${email}</span><button class="delete-participant" data-email="${email}" data-activity="${name}" title="Unregister">✕</button></li>`).join("")}</ul>`
